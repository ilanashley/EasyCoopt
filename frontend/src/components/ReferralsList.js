...
console.log(referralStatus)
  ...
  const handleSelectStatusChange = (event, i) => {
    ...
    console.log('handleSelectStatusChange ----> ', event.target.value, event.key)
    ...
    <div className='mainContainer'>
      ...
      <div className='container-lg'>
        ...
        <div className='selectContainer'>
          <select className="form-select custom-select-style" aria-label="Default select example">
        ...
        <div className='tableContainer'>
          <Referrals referrals={currentReferrals} loading={loading} handleSelectStatusChange={handleSelectStatusChange} referralStatus={referralStatus} />
        </div>

        <div className='perPageContainer'>
          <select defaultValue={referralsPerPage} onChange={handleSelectPerPageChange} className="form-select custom-perPage-style" aria-label="Default select example">
